		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Importa Balancetes",
									"targetURL": "#comfidelidademundialzfibalancetes-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comfidelidademundialzfibalancetes-display": {
								"semanticObject": "comfidelidademundialzfibalancetes",
								"action": "display",
								"description": "Importa Balancetes",
								"title": "Importa Balancetes",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.fidelidademundial.zfibalancetes",
									"url": sap.ui.require.toUrl("com/fidelidademundial/zfibalancetes")
								}
							}
						}
					}
